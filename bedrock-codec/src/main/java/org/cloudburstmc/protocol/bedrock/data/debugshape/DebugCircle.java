...
/**
 * Represents debug circle used in the Bedrock protocol.
 */
@Getter
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public final class DebugCircle extends DebugShape {
    ...
    public DebugCircle(long id, int dimension, @Nullable Vector3f position, @Nullable Float scale,
