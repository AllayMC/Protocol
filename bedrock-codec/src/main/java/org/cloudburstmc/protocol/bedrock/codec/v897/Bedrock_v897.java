...
public class Bedrock_v897 extends Bedrock_v860 {
    ...
    public static final BedrockCodec CODEC = Bedrock_v860.CODEC.toBuilder()
            ...
            .helper(() -> new BedrockCodecHelper_v897(ENTITY_DATA, GAME_RULE_TYPES, ITEM_STACK_REQUEST_TYPES, CONTAINER_SLOT_TYPES, PLAYER_ABILITIES, TEXT_PROCESSING_ORIGINS))
            ...
            .updateSerializer(EventPacket.class, EventSerializer_v897.INSTANCE)
